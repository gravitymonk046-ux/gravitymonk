...
// const Testimonials = () => {
//     return (
//         <section className="py-20 md:py-32 bg-background overflow-hidden border-t border-border/10">
...
//                             className="p-8 rounded-3xl bg-secondary/30 border border-border/50 flex flex-col h-full hover:shadow-xl hover:shadow-primary/5 transition-all duration-500"
//                         >
